describe("Sign In: Correct", function() {
    ...
    it("Existing user should be able to sign in", function() {
        ...
        element(by.xpath('/html/body/div/div[2]/div/div/div[2]/div/div/div[2]/div/form/div[1]/input')).clear().then(function() {

            element(by.xpath('/html/body/div/div[2]/div/div/div[2]/div/div/div[2]/div/form/div[1]/input')).sendKeys(mobile);

        });

        element(by.xpath('/html/body/div/div[2]/div/div/div[2]/div/div/div[2]/div/form/div[2]/input')).clear().then(function() {
